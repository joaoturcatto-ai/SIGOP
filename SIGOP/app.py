...
if menu == "Dashboard":
    ...
    st.markdown("<p style='text-align: center; font-style: italic; color: #b89243;'>Sistema Integrado de Gestão Operacional Policial</p><br>", unsafe_allow_index=True)

    c1, c2, c3 = st.columns(3)
    with c1: st.markdown('<div class="kpi-card"><div class="kpi-number">02</div><div class="kpi-label">Operações em Andamento</div></div>', unsafe_allow_index=True)
    with c2: st.markdown('<div class="kpi-card"><div class="kpi-number">05</div><div class="kpi-label">Operações Planejadas</div></div>', unsafe_allow_index=True)
    with c3: st.markdown('<div class="kpi-card"><div class="kpi-number">14</div><div class="kpi-label">Policiais Empregados Hoje</div></div>', unsafe_allow_index=True)
...
# Rodapé Fixo
st.markdown('<div class="footer">SIGOP 2.0 &nbsp;|&nbsp; <b>Desenvolvido por João T. Turcatto.</b></div>', unsafe_allow_index=True)
